...
export default function Pricing() {
  const handleOrder = (planName: string) => {
    ...
    window.open(`https://wa.me/916377033649?text=${encodeURIComponent(text)}`, '_blank');
  };
        ...
        {CATEGORIES.map((category, catIndex) => (
          <div key={catIndex} className="mb-24 last:mb-16">
            <motion.h3 
              ...
              viewport={{ once: true }}
              className="text-xl md:text-2xl font-display font-bold text-white mb-10 tracking-widest text-center border-b border-white/10 pb-6 w-full max-w-3xl mx-auto"
            >
