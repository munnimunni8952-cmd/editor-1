...
const VideoCard: React.FC<{ videoId: string; index: number }> = ({ videoId, index }) => {
  ...
  return (
    ...
    >
        ...
        {!isPlaying ? (
          <>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-16 h-16 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 group-hover:border-sky-500/50 group-hover:bg-sky-500/20 group-hover:scale-110 transition-all duration-500 shadow-[0_0_30px_rgba(0,0,0,0.5)] group-hover:shadow-[0_0_40px_rgba(56,189,248,0.4)] cursor-pointer" onClick={() => setIsPlaying(true)}>
      ...
      <div className="h-px w-full bg-gradient-to-r from-transparent via-white/10 group-hover:via-sky-500/50 to-transparent transition-colors duration-500" />
...
export default function LongFormVideos() {
  return (
    <section id="long-form" className="py-32 relative bg-transparent overflow-hidden">
      ...
      <div className="absolute top-32 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-sky-500/5 blur-[120px] rounded-[100%] pointer-events-none" />
      <div className="absolute top-1/3 left-0 w-[500px] h-[500px] bg-sky-500/10 rounded-full mix-blend-screen filter blur-[80px] pointer-events-none opacity-40" />
