...
function TypewriterEffect() {
  ...
  return (
    <span className="inline-flex items-center justify-center h-[1.2em] min-w-[280px] md:min-w-[600px]">
      <span className="bg-gradient-to-r from-sky-400 to-cyan-500 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(56,189,248,0.3)]">
        {WORDS[index].substring(0, subIndex)}
      </span>
      <span 
        className={`inline-block w-[4px] h-[0.9em] md:w-[6px] ml-1 md:ml-2 md:h-[0.8em] bg-sky-500 rounded-full transition-opacity duration-100 ${
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:w-[40vw] md:h-[40vw] rounded-full bg-sky-600/10 blur-[60px] mix-blend-screen" />
        <div className="hidden md:block absolute top-1/3 left-1/3 -translate-x-1/2 -translate-y-1/2 md:w-[30vw] md:h-[30vw] rounded-full bg-sky-600/10 blur-[60px] mix-blend-screen" />
      </div>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="relative group/btn">
              <div className="absolute -inset-1 bg-gradient-to-r from-sky-400 to-cyan-500 rounded-full blur-md opacity-40 animate-pulse" />
              <button
                onClick={(e) => {
                  e.preventDefault();
              ...
              >
                <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-sky-400 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            ...
            <a
              href="#work"
              className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 glass-card text-white font-semibold rounded-full transition-all hover:bg-white/10 capitalize"
            >
